                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-3 col-md-2">
                                <router-link to="/"> <img class="logo logo-dark" alt="logo" src="static/img/logo-dark.png"> <img class="logo logo-light" alt="logo" src="img/logo-light.png"></router-link>
                            </div>
        ...
        <div class="main-container">
            ...
            <footer class="text-center-xs space--xs">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-7"> <span class="type--fine-print">© <span class="update-year">2018</span> Autolugu</span> <router-link class="type--fine-print" to="/">Kasutustingimused</router-link> <router-link class="type--fine-print" to="/">Privaatsus</router-link> </div>
